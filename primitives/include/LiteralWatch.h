...
BOOLEAN two_literal_watch(SatState* sat_state, Lit** literals_list, unsigned long num_elements, unsigned long type); // it takes list of literals on which it will run unit resolution
